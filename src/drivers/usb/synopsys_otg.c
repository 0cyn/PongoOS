...
void usb_init(void)
{
    ...
    {
        // iOS 7 didn't have this in DeviceTree. Hardcoding is ugly, but it works.
        // If anyone has a cleaner solution, open a GitHub issue or something.
        gSynopsysComplexBase = gIOBase + 0x0c900000;
    }
    else
    {
